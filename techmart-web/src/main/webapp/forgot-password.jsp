...
<head>
    ...
    <title>TechMart | Reset Password</title>
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="brand-header">
                ...
                <p class="auth-subtitle">Set a new secure password for your TechMart account</p>
            </div>
            ...
            <div class="auth-footer">
                Remember your password? <a href="${pageContext.request.contextPath}/signin.jsp">Sign In</a>
            </div>
        </div>
    </div>
